 async function main() {
     const waveContractFactory = hre.ethers.getContractFactory("WavePortal"); // compile our contract and generate the necessary files we need to work with our contract"WavePortal" and find it  under the artifacts/contracts directory 
     ...
     await waveContract.deploy(); // wait until the contract is successfully deployed to the local blockchain
